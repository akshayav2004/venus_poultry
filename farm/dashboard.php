                  ...
                  if($query->rowCount() > 0)
                  {
                    ...
                    {  
                      ...
                      <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: 30px;" src="assets/img/avatars/avatar15.jpg" alt="logo" /></a>
                        ...
                        <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: auto; width: 400px;" src="assets/img/companyimages/<?php  echo $row->companylogo;?>" alt=""></a>
